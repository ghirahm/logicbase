...
const ProfileContent = () => {
    ...
    return (
        <main className='w-full h-fit flex justify-end my-2 mb-4' id='dashboard'>
            <div className='w-[85%] h-fit flex flex-col gap-6 mr-6'>
                ...
                <section className='w-full h-fit grid grid-cols-3 gap-6 pb-6 border-b-2'>
                    <div className='relative col-span-1 h-full bg-[var(--color-non-primary)] flex flex-col justify-end items-start rounded-3xl overflow-hidden p-6'>
                    ...
                    <div className='col-span-2 flex flex-col gap-8 px-6'>
                        <div className='flex flex-col gap-6 border-b-2 py-6'>
                            ...
                            <div className='rounded-3xl border-2 border-[var(--color-secondary)] w-full flex flex-row items-center justify-between gap-4 p-6 '>
                                ...
                                <img src={Icon} alt='Icon' className='w-[108px]' />
                            </div>
                        </div>
