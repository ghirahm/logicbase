...
const BasicContent = () => {
    ...
    return (
        <>
            <main className='w-full h-fit flex flex-col gap-12 my-[100px]' id='home'>
                <section className='w-full h-[480px] md:h-[360px] lg:h-[480px] xl:h-[640px] relative bg-[var(--color-tertiary)] pt-[20px] overflow-hidden'>
                    <div className='w-[80%] md:w-[90%] lg:w-[80%] xl:w-[80%] h-full mx-auto'>
                        <div className='w-full flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0'>
                            <h1 className='text-[36px] md:text-[48px] lg:text-[72px] xl:text-[100px] text-left leading-tight font-bold text-[var(--color-primary)]'>Improve Your Skills Faster</h1>
                ...
                <section className='w-full h-[120px] md:h-[160px] xl:h-[240px] flex items-center justify-center bg-[var(--color-primary)]'>
                    <div className='w-[80%] h-full flex flex-row flex-wrap md:flex-nowrap justify-center items-center gap-6 md:gap-12 xl:gap-24'>
                        <div className='flex flex-col justify-center items-center gap-2'>
                            ...
                            <p className='text-[12px] md:text-[12px] xl:text-[16px] text-left font-normal text-[var(--color-secondary)]'>500K Review</p>
                        </div>
                        <div className='font-bold'>
                            <h1>|</h1>
                        </div>
                        <div className='flex flex-col justify-center items-center gap-2'>
                            <h2 className='text-[20px] md:text-[32px] xl:text-[64px] text-left leading-none font-bold text-[var(--color-secondary)]'>30M</h2>
                        ...
                        <div className='text-[20px] flex flex-col justify-center items-center gap-2'>
                            <h2 className='md:text-[32px] xl:text-[64px] text-left leading-none font-bold text-[var(--color-secondary)]'>2M+</h2>
                        ...
                        <div className='flex flex-col justify-center items-center gap-2'>
                            <h2 className='text-[20px] md:text-[32px] xl:text-[64px] text-left leading-none font-bold text-[var(--color-secondary)]'>4K+</h2>
                ...
                <section className='w-full h-fit flex items-center justify-center bg-[var(--color-primary)]' id='blog'>
                    <div className='w-[80%] h-full flex flex-col md:grid md:grid-cols-2 xl:grid xl:grid-cols-3 my-0 md:my-12 gap-4'>
