...
const BasicContent = () => {
    ...
    return (
    <>
        <main className='w-full h-auto flex flex-col gap-12 my-[100px]' id='home'>
            <section className='w-full h-[640px] relative bg-[var(--color-tertiary)] overflow-hidden'>
                ...
                <img src={Banner} alt='' className='w-[40%] h-auto absolute bottom-[-50px] m-auto left-0 right-0'/>
            </section>

            <section className='w-full h-[240px] flex items-center justify-center bg-[var(--color-primary)]'>
                <div className='w-[80%] h-full flex flex-row justify-center items-center gap-24'>
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <h2 className='text-[64px] text-left leading-none font-bold text-[var(--color-secondary)]'>4.8</h2>
                        <p className='text-[16px] text-left font-normal text-[var(--color-secondary)]'>500K Review</p>
                    </div>
                    <div className='font-bold'>
                        <h1>|</h1>
                    </div>
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <h2 className='text-[64px] text-left leading-none font-bold text-[var(--color-secondary)]'>30M</h2>
                        <p className='text-[16px] text-left font-normal text-[var(--color-secondary)]'>Enrollments</p>
                    </div>
                    <div className='font-bold'>
                        <h1>|</h1>
                    </div>
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <h2 className='text-[64px] text-left leading-none font-bold text-[var(--color-secondary)]'>2M+</h2>
                        <p className='text-[16px] text-left font-normal text-[var(--color-secondary)]'>Learners</p>
                    </div>
                    <div className='font-bold'>
                        <h1>|</h1>
                    </div>
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <h2 className='text-[64px] text-left leading-none font-bold text-[var(--color-secondary)]'>4K+</h2>
                        <p className='text-[16px] text-left font-normal text-[var(--color-secondary)]'>Popular Courses</p>
                    </div>
                </div>
            </section>

            <section className='w-full h-fit flex items-center justify-center bg-[var(--color-primary)]' id='blog'>
                <div className='w-[80%] h-full grid grid-cols-3 my-12 gap-4'>
                    <div className='relative h-[240px] col-span-2 flex flex-col gap-6 bg-[var(--color-tertiary)] rounded-xl p-6 overflow-hidden border-2 border-[var(--color-tertiary)] transition-all ease-in-out hover:-translate-y-2'>
                        <h2 className='text-[52px] text-left leading-none font-bold text-[var(--color-primary)] text-balance'>Our Features<br></br>Special For You</h2>
                        ...
                        <div className='absolute w-[360px] h-[360px] right-[-120px] bg-[var(--color-primary)] rounded-full top-0 bottom-0 m-auto'></div>
                    </div>
                    <div className='h-[240px] flex flex-col gap-4 bg-[var(--color-primary)] border-2 border-b-8 border-[var(--color-non-primary)] hover:border-[var(--color-tertiary)] rounded-xl p-6 transition-all ease-in-out duration-300 hover:-translate-y-2 opacity-80 hover:opacity-100'>
                        <FontAwesomeIcon icon={faWandMagicSparkles} className='w-[36px] h-[36px] text-[var(--color-secondary)]' />
                        <h3 className='text-[20px] text-left leading-none font-bold text-[var(--color-secondary)]'>Logic Base Empower Your Mind</h3>
                    ...
                    <div className='h-[240px] flex flex-col gap-4 bg-[var(--color-primary)] border-2 border-b-8 border-[var(--color-non-primary)] hover:border-[var(--color-tertiary)] rounded-xl p-6 transition-all ease-in-out duration-300 hover:-translate-y-2 opacity-80 hover:opacity-100'>
                        ...
                        <h3 className='text-[20px] text-left leading-none font-bold text-[var(--color-secondary)]'>Logical Thinking Matters</h3>
                    ...
                    <div className='h-[240px] flex flex-col gap-4 bg-[var(--color-primary)] border-2 border-b-8 border-[var(--color-non-primary)] hover:border-[var(--color-tertiary)] rounded-xl p-6 transition-all ease-in-out duration-300 hover:-translate-y-2 opacity-80 hover:opacity-100'>
                        ...
                        <h3 className='text-[20px] text-left leading-none font-bold text-[var(--color-secondary)]'>Creator Behind the Vision</h3>
                    ...
                    <div className='h-[240px] flex flex-col gap-6 bg-[var(--color-primary)] border-2 border-b-8 border-[var(--color-non-primary)] hover:border-[var(--color-tertiary)] rounded-xl p-6 transition-all ease-in-out duration-300 hover:-translate-y-2 opacity-80 hover:opacity-100'>
                        <FontAwesomeIcon icon={faCopy} className='w-[36px] h-[36px] text-[var(--color-non-primary)]hover:text-[var(--color-secondary)]' />
                        <h3 className='text-[20px] text-left leading-none font-bold text-[var(--color-secondary)]'>Inspired by The Best</h3>
