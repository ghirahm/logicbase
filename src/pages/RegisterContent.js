            ...
            <div className='w-[40%] h-full flex flex-col justify-center items-center gap-6 mx-auto'>
                ...
                <div className='w-full'>
                    <form action='#' method='POST' className='space-y-4'>
                        ...
                        <input id='name' name='name' type='name' required autoComplete='name'  placeholder='Full Name' className='w-full rounded-full p-4 text-[var(--color-secondary)] bg-[var(--color-primary)] placeholder:text-[var(--color-non-primary)] focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-accent)]' />
                        ...
                        <button onClick={() => navigate('/login')} className='flex w-full justify-center items-center rounded-full font-bold bg-[var(--color-primary)] text-[var(--color-secondary)] p-4 ease-in-out duration-300 hover:border-b-8 hover:border-[var(--color-accent)]'>
