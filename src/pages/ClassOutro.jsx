...
const ClassOutro = () => {
    ...
    return (
        <main className='my-0 lg:my-12'>
            <section className='w-full h-fit flex flex-col justify-center items-center pt-[120px] p-0 lg:p-6'>
                <div className='w-full h-full flex flex-col justify-between text-[var(--color-secondary)] rounded-3xl p-6 gap-12'>
                    <div className='w-full h-[80vh] relative flex flex-col gap-4 justify-center items-center text-[var(--color-primary)] rounded-3xl p-6 overflow-hidden'>
                        ...
                        <p className='w-full md:w-[30%] text-sm leading-6 z-20 text-center'>Tetap semangat untuk terus belajar dan berkembang! Jangan lupa klaim reward Anda sekarang dan nikmati hasil dari kerja keras Anda!</p>
                    </div>
